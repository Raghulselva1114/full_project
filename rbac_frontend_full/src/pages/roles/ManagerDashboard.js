...
export default function ProjectCards3D() {
  ...
  return (
    <div className="min-h-screen p-6 bg-slate-50">
      <h2 className="text-3xl font-bold tracking-tight text-center mb-8">Project Dashboard</h2>
          ...
          <Card key={project.id} className="overflow-hidden hover:shadow-lg transition-all hover:-translate-y-1 block">
            <CardContent className="p-0">
              <div className="p-4 border-b">
                <h3 className="text-xl font-bold text-center capitalize">{project.project_name || project.name}</h3>
              </div>
              <div className="p-4">
                <img 
